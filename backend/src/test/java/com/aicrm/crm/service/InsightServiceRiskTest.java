...
class InsightServiceRiskTest {
    ...
    private InsightService newService() {
        ...
        return new InsightService(customerService, knowledge, embeddingClient, vectorRepo, provider, governance, chatMemory, systemSettings, "", "https://api.openai.com", 8000);
    }
