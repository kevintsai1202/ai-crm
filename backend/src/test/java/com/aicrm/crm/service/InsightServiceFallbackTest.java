...
class InsightServiceFallbackTest {
    ...
    void chat_withoutApiKey_usesDeterministicFallback() {
        ...
        var service = new InsightService(customerService, knowledge, embeddingClient, vectorRepo, provider, governance, chatMemory, systemSettings, "", "https://api.openai.com"); // 空金鑰 → aiEnabled=false
